...
def process_pose_detection():
    ...
    cv2.namedWindow('Visual Human Pose Estimation', cv2.WINDOW_NORMAL)
    ...
    while camera_video.isOpened():
        ...
        # Display the frame.                
        cv2.imshow('Visual Human Pose Estimation', frame) 
...
def start_process():
    ...
    return 'Process will be starting soon. Please wait!'
